  ...
  <table class="table_form" width="100%" cellspacing="0">
    <tbody>
      <tr>
        ...
        <td>
          <input name="poster[name]" id="name" class="input-text" type="text" size="25">
        </td>
      </tr>
      <tr>
        <th><?php echo L('for_postion')?>：</th>
        <td>
          <?php if($spaceid) { echo '<b style="color:#F60;">',$sinfo['name'],'</b>&nbsp;[',$TYPES[$sinfo['type']],']<input type="hidden" name="poster[spaceid]" value="'.$spaceid.'">'; } else {?>
          <select name="poster[spaceid]" id="spaceid" onchange="AdsType(this.value)">
          ...
          <?php }?>
          <?php echo $sinfo['description']?('(<font color="#FF0000">'.$sinfo['description'].'</font>)'):'';?>
        </td>
      </tr>
      <tr>
        <td align="right"  valign="top"><?php echo L('listorder')?></td>
        <td valign="top" colspan="2">
          <input type="text" name="poster[listorder]" id="listorder" class="input-text" size="5" value="">
          </input>
        </td>
      </tr>
      <tr>
      ...
      <table width="100%"  class="table_form">
        <tbody>
          <tr>
            ...
            <td class="y-bg">
              <input type="text" class="input-text" name="setting[images][<?php echo $i;?>][linkurl]" id="linkurl<?php echo $i;?>" size="30" value="http://" />
            </td>
            <td rowspan="2">
              <a href="javascript:flashupload('imgurl<?php echo $i;?>_images', '<?php echo L('upload_photo')?>','imgurl<?php echo $i;?>',preview,'1,<?php echo $this->M['ext']?>,1','poster', '', '<?php echo $authkey?>');void(0);"><img src="<?php echo IMG_PATH;?>icon/upload-pic.png" id="imgurl<?php echo $i;?>_s" width="105" height="88"></a>
              <input type="hidden" id="imgurl<?php echo $i;?>" name="setting[images][<?php echo $i;?>][imageurl]">
            </td>
          </tr>
          <tr>
            <th><?php echo L('alt')?>：</th>
            <td class="y-bg">
              <input type="text" class="input-text" name="setting[images][<?php echo $i;?>][alt]" id="alt<?php echo $i;?>" size="30" />
            </td>
          </tr>
      </table>
      <?php } } else {?>
      <table width="100%"  class="table_form">
        <tbody>
          <tr>
            <th width="80"><?php echo L('linkurl')?>：</th>
            <td class="y-bg">
              <input type="text" class="input-text" name="setting[images][1][linkurl]" id="linkurl3" size="30" value="http://" />
            </td>
            <td rowspan="2">
              <a href="javascript:flashupload('imgurl_images', '<?php echo L('upload_photo')?>','imgurl',preview,'1,<?php echo $this->M['ext']?>,1','poster', '', '<?php echo $authkey?>');void(0);"><img src="<?php echo IMG_PATH;?>icon/upload-pic.png" id="imgurl_s" width="105" height="88"></a>
              <input type="hidden" id="imgurl" name="setting[images][1][imageurl]">
            </td>
          </tr>
          <tr>
            <th><?php echo L('alt')?>：</th>
            <td class="y-bg">
              <input type="text" class="input-text" name="setting[images][1][alt]" id="alt3" size="30" />
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table width="100%"  class="table_form">
        <tbody>
          <tr>
            ...
            <td class="y-bg">
              <input type="text" class="input-text" name="setting[flash][<?php echo $i;?>][flashurl]" id="flashurl<?php echo $i;?>" size="40" />
            </td>
            <td class="y-bg">
      ...
      <table width="100%"  class="table_form">
        <tbody>
          <tr>
            <th width="80"><?php echo L('flash_url')?>：</th>
            <td class="y-bg">
              <input type="text" class="input-text" name="setting[flash][1][flashurl]" id="flashurl" size="40"  />
            </td>
            <td class="y-bg">
