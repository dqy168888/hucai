<?php return array (
  'name' => '虎彩英文模板',
  'author' => 'hucai_en TEAM',
  'dirname' => 'hucai_en_en',
  'homepage' => 'http://www.hucai_ens.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|hucai_en|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|hucai_en|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|hucai_en|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|hucai_en|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|hucai_en|wap' => 
    array (
    ...
    'templates|hucai_en|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|hucai_en|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|hucai_en|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|hucai_en|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|hucai_en|yp' => 
    array (
      'com_hucai_en' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|hucai_en|yp|com_hucai_en' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|hucai_en|comment' => 
    array (
