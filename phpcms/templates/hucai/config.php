<?php return array (
  ...
  'author' => 'HUCAI TEAM',
  'dirname' => 'hucai',
  'homepage' => 'http://www.hucais.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|hucai|content' => 
    array (
      'category.html' => '文章频道页',
      'category_download.html' => '下载频道页',
      'category_picture.html' => '图片频道页',
      'category_brand.html' => '品牌活动频道页',
      'category_custom.html' => '线上定制频道页',
      'category_news.html' => '新闻频道页',
      'category_solutions.html' => '解决方案频道页',
      'download.html' => '下载连接页',
      'footer.html' => '底部',
      'header.html' => '顶部',
      'header_min.html' => '迷你顶',
      ...
      'list_brand.html' => '品牌活动列表页',
      'list_custom.html' => '线上定制列表页',
      'list_solutions.html' => '解决方案列表页',
      ...
      'show_brand.html' => '品牌活动内容页',
      'show_custom.html' => '线上定制内容页',
      'show_solutions.html' => '解决方案内容页',
    ...
    'templates|hucai|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|hucai|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|hucai|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|hucai|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|hucai|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|hucai|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|hucai|yp' => 
    ...
    'templates|hucai|yp|com_hucai' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|hucai|comment' => 
    array (
